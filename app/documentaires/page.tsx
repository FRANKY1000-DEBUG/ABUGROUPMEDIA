...
const CATEGORY_SLUG = "documentaires";
const CATEGORY_LABEL = "Documentaires";
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="border-b border-line px-4 pb-8 pt-8 md:px-10">
          ...
          <p className="max-w-[520px] text-[14.5px] leading-relaxed text-muted">
            Récits longs formats sur la culture, l&apos;histoire et la société camerounaise.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between px-4 pb-4 pt-6 md:px-10">
          <span className="text-[13px] text-muted">{list.length} documentaires</span>
        </div>
        <div className="grid grid-cols-2 gap-5 px-4 pb-16 sm:grid-cols-3 md:grid-cols-4 md:px-10">
          ...
          {list.length === 0 && (
            <p className="col-span-full text-sm text-muted">Aucun documentaire publié pour le moment.</p>
          )}
        </div>
      </div>
    </div>
